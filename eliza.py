...
# Reflections dictionary for pronoun switching
reflections = {
    "am": "are",
    "was": "were",
    "i": "you",
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_input.lower() == "quit":
            print("ELIZA:", random.choice(["Goodbye.", "Take care.", "Thank you for talking with me."]))
            break
