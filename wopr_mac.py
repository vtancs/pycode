...
# Helper function to find files inside a macOS .app bundle
def resource_path(relative_path):
    """ Get absolute path to resource, works for dev and for py2app """
    if hasattr(sys, 'frozen'):
        # When bundled, files are in Contents/Resources/
...
class WOPRTerminal:
    ...
    def load_data(self):
        # Use resource_path for the data file
        data_file = resource_path(self.target_file)
...
if __name__ == "__main__":
    # Check if a file was passed as argument; otherwise default to data.txt
